    ...
    <div className="col-md-4">
        <div className='card border-0'>
            <div className='card-img-top'>
                {
                    enrollment.course.image && <img src={enrollment.course.image} alt="" className='img-fluid' />
                }
                {
                    !enrollment.course.image && <img src={`https://placehold.co/600x350?text=${enrollment.course?.title}`} alt="" className='img-fluid' />
                }
            </div>
